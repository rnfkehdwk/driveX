      ...
      <div style={{ padding: '20px 16px' }}>
        {menus.map((m) => (
          <div key={m.path} onClick={() => nav(m.path)} style={{
            ...
            border: '1px solid #f1f5f9', boxShadow: '0 1px 3px rgba(0,0,0,0.03)', transition: 'transform 0.1s',
          }}
          onTouchStart={e => e.currentTarget.style.transform = 'scale(0.98)'}
          onTouchEnd={e => e.currentTarget.style.transform = 'scale(1)'}>
            <div style={{ width: 48, height: 48, borderRadius: 14, background: m.bg, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24, flexShrink: 0 }}>{m.icon}</div>
            <div style={{ flex: 1 }}>
